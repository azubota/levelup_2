...
export class Translate extends React.Component {
			...
			locations: [
				{
					...
					address: "1050 4th st, Miami Beach, FL",
					phone: "305-222-5793",
					latitude: "25.7702",
					longitude: "-80.3343"
				},
				{
					...
					address: "4100 Prarie Ave, Miami Beach, FL",
					phone: "305-402-0078",
					latitude: "25.75900",
					longitude: "-80.3366"
				},
				{
					...
					address: "1420 Washington Ave, Miami Beach, FL",
					phone: "305-657-5843",
					latitude: "25.7551",
					longitude: "-80.3366"
				}
	...
	prepareTranslations() {
		...
		if (this.state.currentLang != 3) {
			...
			this.executeTranslation(
				"Some useful keywords that might help you for your first day of school",
				"en",
				this.state.patientLanguage[this.state.currentLang].id,
				"usefulKeywords"
			);
	...
	showPos() {
		...
		function showPosition(position) {
			...
			let points = "&markers=color:green%7Clabel:Y%7C" + latlon;
	...
	render() {
							...
							<div className="row justify-content-center">
								<div className={cardResponsive}>
									<div className="card top-card text-center">
										<h3 className="card-header border-0 card-title py-4 bg-white font-style-bold text-success">
											<img src={""} height="80" />
											<br />
											{this.state.appname}
										</h3>
										<div className="card-body">
											<p className="text-success h5 mb-5">
												Hola! - Bonjou! - Hello!
											</p>
											...
											<select
												className="custom-select mb-4 text-success"
												onChange={e =>
													this.setState({
														currentLang:
															e.target.value
			...
			return (
				<div>
					<div className="container">
						<div className="row justify-content-center">
							<div className={cardResponsive}>
								<div className="card top-card text-center text-success">
											...
											<div
												...
												<div className="card">
													...
													<div
														...
														<div className="card-body text-left text-success">
															<div className="row">
		...
		if (this.state.currentStep == 3) {
			...
			let keywords =
				"This will be keywords to help with first day of school";

			let translatedKeywords =
				"We will send you a summary of above and a copy of your translated document via email. Just click Send Me An Email";
						...
						<div className="row justify-content-center">
							<div className={cardResponsive}>
								<div className="card top-card text-center text-success">
									...
									<div className="card-body">
										<div>
											<h5 className="text-primary text-success">
												{
										...
										<div className="mb-4">
											<p>
												Hello. Below are some things to
												help you prepare your child for
												their new school based on the
												zipcode you entered.
											</p>

											<p id="green">
												<strong>
													Vaccines Needed to Enroll:
												</strong>
